import type { IntrospectResponse, TokenExchangeResponse } from './types';
...
export class AuthService {
	...
	/**
	 * Generates a Basic Authentication header value by encoding the client ID and client secret in base64 format.
	 * @returns A string representing the Basic Authentication header value.
	 */
